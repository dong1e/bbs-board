...
<%@include file="./includes/header.jsp" %>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>BBS Get Page</div>
                            <div class="card-body">
                ...
                <script type="text/javascript">
					$(document).ready(function() {
						...
						function showReplyPage(replyCnt) {
							...
							var str = "<ul class='pagenation float-right'>";
						...
						$(".chat").on("click", "li", function(e) {
							...
							replyService.get(rno, function(result) {
								...
								modalInputReplyDate.val(replyService.displayTime(result.replyDate)).attr("readonly", "readonlyly");
						...
						/* replyService.get(12, function(result){
							console.log(result);
						}); */
					});
                </script>
